...
(function () {
  ...
  const centrosMunicipais = {
    ...
    'botucatu': [-22.885, -48.445], 'araras': [-22.357, -47.384], 'maua': [-23.6677, -46.4613], 'sao vicente': [-23.96, -46.396],
    'araraquara': [-21.794, -48.175], 'jandira': [-23.527, -46.902], 'mogi das cruzes': [-23.522, -46.188], 'tatui': [-23.3556, -47.856], 'dois corregos': [-22.3667, -48.3833],
    'iaras': [-22.8689, -49.1639], 'pindamonhangaba': [-22.9246, -45.4613], 'suzano': [-23.5428, -46.3108], 'guaruja': [-23.9931, -46.2564], 'cruzeiro': [-22.5762, -44.9626],
